...
class IntExtenders
{
    public static inline function htiles(x: Int)           return x * Consts.TileWidth;
    public static inline function htile(x: Int)            return x * Consts.TileWidth;
    public static inline function vtiles(y: Int)           return y * Consts.TileHeight;
    public static inline function vtile(y: Int)            return y * Consts.TileHeight;
